...
app.get('/customers/:id', function(req, res) {
    ...
    request.get('http://customer-service:8071/customers/1', function(error, response, body) {
...
app.post('/processPayment', function(req, res) {
    ...
    request.post('http://payment-service:8074/processPayment', {
...
app.post('/orders', function(req, res) {
    ...
    request.post('http://order-service:8073/orders',{
        body: JSON.stringify(req.body)}, function(error, response, body) {
        // console.log('error:', error);
        // console.log('statusCode:', response && response.statusCode);
        // console.log('reqParams:', req.params);
